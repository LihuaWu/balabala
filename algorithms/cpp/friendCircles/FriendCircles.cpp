...
class Solution {
   public:
    // -----------------------------------------------------------------------------
    // DFS solution is quite easy to understand, just like the "Number of
    // Island"
    ...
    // if x and y are already in same friend cicle, then return false, else
    // return true;
